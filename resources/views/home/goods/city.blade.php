...
<div class="container w">
    ...
    <div class="main clearfix">
        <div class="reg-form fl">
            <form action="/homes/city" id="register-form" method="post" novalidate="novalidate" style="width:500px;">
            	{{csrf_field()}}
                <div class="form-item form-item-account" id="form-item-account">
                    <label>收　货　人</label>
                    <input type="hidden" name="uid" value="{{$uid}}">
                   <input type="text" id="form-account" style="" name="mname" class="field" autocomplete="off" maxlength="20" placeholder="收货人姓名" default="&lt;i class=&quot;i-def&quot;&gt;&lt;/i&gt;支持中文、字母、数字、“-”“_”的组合，4-20个字符">
                    <i class="i-status"></i>
                </div>
                <div class="input-tip">
                    <span></span>
                ...
                <div>
                    <button type="submit" class="btn-register" style="background:#ff4f03">提交信息</button>
                </div>
            </form>
        </div>
