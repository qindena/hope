                        ...
                        <div class="mc">
                            <div class="user-set userset-lcol">
                                <div class="form">
                                    ...
                                    <form method="post" action="/home/usrelnfo" enctype="multipart/form-data">
                                        <div class="item">
                                            <span class="label">
                                                <em>
                                                    *
                                            ...
                                            <div class="fl">
                                                ...
                                                maxlength="20" id="nickName" name="mname" value="">
                                                <div class="clr">
                                                </div>
                                                <div class="prompt-06">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <input type="text" class="itxt"
                                                maxlength="20" id="nickName" name="email" value="">
                                                <div class="clr">
                                                </div>
                                                <div class="prompt-06">
                                                    <span id="nickName_msg">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <input type="text" class="itxt"
                                                maxlength="20" id="nickName" name="address" value="">
                                                <div class="clr">
                                                </div>
                                                <div class="prompt-06">
                                                    <span id="nickName_msg">
                                        ...
                                        <div class="item">
                                            ...
                                            <div class="fl">
                                                <input type="file" name="header" value="" class="text-word"
                                                required="">
                                                <div class="clr">
                                                </div>
                                                <div class="prompt-06">
                            ...
                            <div id="user-info">
                                <div class="u-pic">
                                    <img alt="用户头像" src="/home/lnfo/photo.jpg">
                                    <div class="mask">
                                    </div>
